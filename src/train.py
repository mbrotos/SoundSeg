...
if __name__ == "__main__":
    ...
    parser.add_argument("--quantile_scaler", action="store_true", default=False)
    parser.add_argument("--q_min", type=float, default=25.0)
    parser.add_argument("--q_max", type=float, default=75.0)
